...
from .lisde_network import LISDETrainingNetwork, LISDEPredictionNetwork


class LISDEEstimator(PyTorchEstimator):
    def __init__(
        self,
        input_size: int,
        freq: str,
    ...
    def create_training_network(self, device: torch.device) -> LISDETrainingNetwork:
        return LISDETrainingNetwork(
    ...
    def create_predictor(
        ...
        trained_network: LISDETrainingNetwork,
        device: torch.device,
    ) -> Predictor:
        prediction_network = LISDEPredictionNetwork(
            input_size=self.input_size,
            num_layers=self.num_layers,
            num_cells=self.num_cells,
            cell_type=self.cell_type,
