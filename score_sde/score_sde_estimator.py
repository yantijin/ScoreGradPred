...
from .score_sde_network import ScoreGradTrainingNetwork, ScoreGradPredictionNetwork


class ScoreGradEstimator(PyTorchEstimator):
    def __init__(
        self,
        input_size: int,
        freq: str,
    ...
    def create_training_network(self, device: torch.device) -> ScoreGradTrainingNetwork:
        return ScoreGradTrainingNetwork(
    ...
    def create_predictor(
        ...
        trained_network: ScoreGradTrainingNetwork,
        device: torch.device,
    ) -> Predictor:
        prediction_network = ScoreGradPredictionNetwork(
            input_size=self.input_size,
            num_layers=self.num_layers,
            num_cells=self.num_cells,
            cell_type=self.cell_type,
